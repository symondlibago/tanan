...
(2, 'ngano@gmail.com', 'shox', 'Student', 'Activate'),
(3, 'hey@gmail.com', 'shox', 'Teacher', 'Active'),
(4, 'bunjan.mark476@gmail.com', 'shox', 'Student', 'Activate'),
(5, '12312@g.com', 'teacher123*', 'Teacher', 'Active'),
(7, '1', 'student123*', 'Student', ''),
(8, '2', 'student123*', 'Student', ''),
(9, '3', 'student123*', 'Student', ''),
(10, '', 'student123*', 'Student', '');
...
(1, 'MIT', 2, 4, 'ITP', '', '07-06-23'),
(2, 'MIT', 2, 4, 'MBAD', '', '07-06-23');
...
(4, 'MARK', 'VINCENT', 'BUNJAN', 'dfsdf@', 'bunjan.mark476@gmail.com', '09161508298', 'Select Course', 'Select Ses', '', 'Select Opt', 'Select Opt', '', 'Select Option', 'Select Option', '', '', 'Select Gen', '101 Tagapulot st. Bulua', '', '', '', '', '', '', '', '', '', '', '', NULL, NULL, NULL, NULL, '2023-06-03 09:44:39');
...
--
ALTER TABLE `student_courses`
  MODIFY `student_course_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `student_info`
  MODIFY `roll_no` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1213;
